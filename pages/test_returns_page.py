...
class ReturnsPageAPITests(APITestCase):
    def test_returns_page_includes_seeded_component(self):
        ...
        self.assertEqual(
            ...
            "ამ გვერდზე აღწერილია როგორ უნდა მოითხოვოთ პროდუქტის დაბრუნება AutoMate-ზე, რა ვადები მოქმედებს ჩვეულებრივი და დეფექტიანი დაბრუნების შემთხვევაში, ვინ ფარავს დაბრუნების ხარჯს და როგორ მუშავდება თანხის დაბრუნება.",
        )
        self.assertEqual(component_payload["data"]["contentData"]["listcount"], 6)
        self.assertEqual(
            [item["title"] for item in items],
            [
                "როგორ დავიწყოთ დაბრუნება",
                "ჩვეულებრივი დაბრუნება 14 დღეში",
                "დეფექტიანი ან არასწორი პროდუქტი",
                "ნივთის მდგომარეობა და კომპლექტაცია",
                "თანხის დაბრუნების ვადა და მეთოდი",
                "დაბრუნების ხარჯი და დახმარება",
            ],
        )
