...
CONTENT_NAME = "login_highlights"
COMPONENT_TYPE_NAME = "Login"
PAGE_SLUG = "login"

SECTION_TITLE = "შედით თქვენს Flex[[Drive]] ანგარიშში"
SECTION_SUBTITLE = (
    "მართეთ შეკვეთები, სურვილების სია და მიწოდების მონაცემები ერთ ადგილას."
)
SECTION_BUTTON_TEXT = "FlexDrive ანგარიში"
...
HIGHLIGHT_ITEMS = (
    {
        ...
        "description": "ნახეთ შეკვეთების ისტორია და მიმდინარე სტატუსები პროფილიდან.",
    },
    {
        "match_titles": ("სასურველები", "სურვილების სია"),
        "position": 2,
        "title": "სურვილების სია",
        "description": "შეინახეთ საჭირო ნაწილები და მოგვიანებით სწრაფად დაუბრუნდით.",
    },
)
...
def refresh_login_component(apps, schema_editor):
    ...
    for item_definition in HIGHLIGHT_ITEMS:
        item = _find_item(
            items,
            used_ids,
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("pages", "0046_refresh_footer_settings"),
    ]

    operations = [
        migrations.RunPython(refresh_login_component, migrations.RunPython.noop),
    ]
