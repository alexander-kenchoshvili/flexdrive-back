...
class PaymentMethodsPageAPITests(APITestCase):
    def test_payment_methods_page_includes_seeded_component(self):
        ...
        self.assertEqual(
            ...
            "ამ გვერდზე აღწერილია რომელი გადახდის მეთოდებია ხელმისაწვდომი AutoMate-ზე, როგორ მუშაობს ნაღდი ანგარიშსწორება, რა ეტაპზე ჩაირთვება ბარათით გადახდა და რა ხდება გადახდის წარუმატებლობის ან თანხის დაბრუნების შემთხვევაში.",
        )
        ...
        self.assertEqual(
            ...
            [
                ...
                "ონლაინ ბარათით გადახდა",
                "როდის ითვლება გადახდა დასრულებულად",
                "წარუმატებელი ან გაუქმებული გადახდა",
                "უსაფრთხოება, თანხის დაბრუნება და დახმარება",
            ],
        )
        self.assertTrue(
