...
class Order(TimeStampedModel):
    ...
    easyway_tracking_status = models.CharField(max_length=80, blank=True, default="")
    easyway_tracking_at = models.DateTimeField(null=True, blank=True)
    easyway_tracking_history = models.JSONField(default=list, blank=True)
    easyway_tracking_checked_at = models.DateTimeField(null=True, blank=True)
    easyway_tracking_attempted_at = models.DateTimeField(null=True, blank=True)
    easyway_tracking_error = models.TextField(blank=True, default="")
    easyway_tracking_token = models.UUIDField(null=True, blank=True, editable=False)
    easyway_tracking_lock_until = models.DateTimeField(null=True, blank=True, editable=False)
