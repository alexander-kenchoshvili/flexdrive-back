...
CROSSMOTORS_SALE_HOLD_SECONDS = max(
    _parse_int_env("CROSSMOTORS_SALE_HOLD_SECONDS", 60 * 60 * 24),
    60,
)
...
EASYWAY_API_USER = os.getenv("EASYWAY_API_USER", "").strip()
EASYWAY_API_KEY = os.getenv("EASYWAY_API_KEY", "").strip()
EASYWAY_API_BASE_URL = os.getenv(
    "EASYWAY_API_BASE_URL",
    "https://easyway.ge/api",
).strip().rstrip("/")
EASYWAY_HTTP_CONNECT_TIMEOUT_SECONDS = _parse_int_env(
    "EASYWAY_HTTP_CONNECT_TIMEOUT_SECONDS",
    5,
)
EASYWAY_HTTP_READ_TIMEOUT_SECONDS = _parse_int_env(
    "EASYWAY_HTTP_READ_TIMEOUT_SECONDS",
    15,
)
EASYWAY_SENDER_CITY_ID = _parse_int_env("EASYWAY_SENDER_CITY_ID", 0)
EASYWAY_SENDER_NAME = os.getenv("EASYWAY_SENDER_NAME", "").strip()
EASYWAY_SENDER_TAX_CODE = os.getenv("EASYWAY_SENDER_TAX_CODE", "").strip()
EASYWAY_SENDER_ADDRESS = os.getenv("EASYWAY_SENDER_ADDRESS", "").strip()
EASYWAY_SENDER_PHONE = os.getenv("EASYWAY_SENDER_PHONE", "").strip()
EASYWAY_SENDER_REGION_ID = _parse_int_env("EASYWAY_SENDER_REGION_ID", 0)
EASYWAY_SENDER_LEGAL_FORM_ID = _parse_int_env(
    "EASYWAY_SENDER_LEGAL_FORM_ID",
    0,
)
EASYWAY_RECEIVER_TAX_CODE_PLACEHOLDER = os.getenv(
    "EASYWAY_RECEIVER_TAX_CODE_PLACEHOLDER",
    "11111111111",
).strip()
EASYWAY_STANDARD_PACKAGE_ID = _parse_int_env("EASYWAY_STANDARD_PACKAGE_ID", 2)
EASYWAY_DELIVERY_MARGIN_GEL = os.getenv(
    "EASYWAY_DELIVERY_MARGIN_GEL",
    "2.00",
).strip()
EASYWAY_INTERNAL_DELIVERY_PRICE_GEL = os.getenv(
    "EASYWAY_INTERNAL_DELIVERY_PRICE_GEL",
    "0.00",
).strip()
EASYWAY_QUOTE_MAX_AGE_SECONDS = _parse_int_env(
    "EASYWAY_QUOTE_MAX_AGE_SECONDS",
    900,
)
